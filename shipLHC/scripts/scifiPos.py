...
for event in eventTree:
     ...
     #addToFile('{0:<5}  {1:>10}  {2:>10}  {3:>10}  {4:>10}'.format(Nevent, round(fitMeanX, 2), round(fitVarX, 2), round(fitMeanY, 2), round(fitVarY, 2)))
...
h['res'].cd(3)
h['res_d'].Draw()
h['res'].Print('/home/fabio/Simulations/numu_sim_25_July_2022/scifi_res_2.png')
