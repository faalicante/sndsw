...
ut.bookCanvas(h, 'map', '2d map', 1800, 1800, 1, 2)
h['map'].SetCanvasSize(1800, 2400)
h['map'].SetWindowSize(1850, 1200)
for i in range(18):
     for j in range(10):
          ut.bookHist(h, 'eml_map_'+str(i)+str(j), 'eml_tracks_'+str(i)+str(j), nBins, targetRangeX[0], targetRangeX[1], nBins, targetRangeY[0], targetRangeY[1])
          ut.bookHist(h, 'scifi_map_'+str(i)+str(j), 'scifi_bar_'+str(i)+str(j), nBins, targetRangeX[0], targetRangeX[1], nBins, targetRangeY[0], targetRangeY[1])
...
for i in range(1):
     ...
     for j in range(10):
          ...
          if j != 10:
               h['eml_map_'+str(i)+str(j)].SetMarkerColor(j+1)
               h['scifi_map_'+str(i)+str(j)].SetMarkerColor(j+1)
          else:
               h['eml_map_'+str(i)+str(j)].SetMarkerColor(j+2)
               h['scifi_map_'+str(i)+str(j)].SetMarkerColor(j+2)
          h['eml_map_'+str(i)+str(j)].SetMarkerSize(0.8)
          h['scifi_map_'+str(i)+str(j)].SetMarkerSize(1.5)
...
h['map'].Print('/home/fabio/Scrivania/2dmap_1.png')
...
#h['res'].cd(3)
#h['res_d'].Draw()
#h['res'].Print('/home/fabio/Simulations/numu_sim_25_July_2022/eml_res_3.png')
#
#fitFile.close()